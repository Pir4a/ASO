    ...
    <div className="space-y-10">
      <section className="py-8 md:py-12">
        <div className="grid gap-8 md:grid-cols-[2fr,1fr] md:items-center">
          <div className="space-y-6">
            <p className="inline-flex rounded-full bg-background px-4 py-1.5 text-sm font-bold text-primary shadow-sm ring-1 ring-primary/20">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <span className="rounded-full bg-background px-4 py-2 text-sm font-semibold text-foreground/90 shadow-sm">
                SEO &amp; hreflang
              </span>
              <span className="rounded-full bg-background px-4 py-2 text-sm font-semibold text-foreground/90 shadow-sm">
                RGPD + a11y
          ...
          <div className="rounded-2xl bg-background p-6 shadow-md ring-1 ring-primary/15">
      ...
      <section className="card space-y-4 p-6">
        <div className="flex items-center justify-between">
          ...
          <p className="text-sm text-foreground/70">Modifiable depuis le backoffice.</p>
        </div>
      ...
      <section className="card space-y-4 p-6">
        <div className="flex items-center justify-between">
          ...
          <p className="text-sm text-foreground/70">Ordre éditable depuis le backoffice.</p>
        </div>
      ...
      <section className="card space-y-4 p-6">
        <div className="flex items-center justify-between">
          ...
          <p className="text-sm text-foreground/70">Sélection backoffice, grilles optimisées.</p>
        </div>
      ...
      <section className="card p-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-2">
            ...
            <a
              href="/contact"
              className="rounded-md border border-primary/25 px-4 py-2 text-sm font-semibold text-foreground hover:border-primary hover:text-primary"
            >
              Contacter l&apos;équipe
            </a>
          </div>
