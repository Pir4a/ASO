    ...
    <AuthGuard requiredRole="admin">
      <div className="mx-auto max-w-4xl space-y-4">
        ...
        <div className="card p-6 space-y-3">
          {user ? (
            <p className="text-foreground/90">Connecté en tant que: {user.email} (Rôle: {user.role})</p>
          ) : (
            <p className="text-foreground/90">Chargement des informations de l'utilisateur...</p>
          )}
