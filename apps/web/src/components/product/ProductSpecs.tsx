    ...
    <section className="overflow-hidden rounded-2xl border border-foreground/10 bg-white">
      ...
      <dl className="divide-y divide-foreground/5">
        {entries.map(([key, value], i) => (
          ...
          >
            {/* Spec keys/values come from the DB in English; dir="auto" lets each
                inherit its own paragraph direction so they read correctly inside
                an RTL page wrapper without manually re-aligning. */}
            <dt
              dir="auto"
